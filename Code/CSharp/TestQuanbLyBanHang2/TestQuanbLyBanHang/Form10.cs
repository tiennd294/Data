    ...
    public partial class Form10 : Form
    {
        ...
        public void loaddata2()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM KhachHang WHERE ThanhPho='"+comboBox1.Text.ToString()+"'", kn.con);
                DataTable dt = new DataTable();
                dt.Clear();
                da.Fill(dt);
        ...
        public void loaddata()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("SELECT Count(*) FROM KhachHang WHERE ThanhPho='" + comboBox1.Text.ToString() + "'", kn.con);
                DataTable dt = new DataTable();
                dt.Clear();
                da.Fill(dt);
