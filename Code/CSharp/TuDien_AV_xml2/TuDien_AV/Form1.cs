...
namespace TuDien_AV
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            Form2 frm = new Form2();
            frm.Text = "Edit";
            frm.TextBox1_Form2.Text = comboBox2.Text;
            frm.ShowDialog();
            LoadData();
            LoadData2();
        ...
        private void comboBox2_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                ...
                XDocument xmldoc = XDocument.Load("data.xml");
                richTextBox2.Text = xmldoc.XPathSelectElement("//Language[@English='" + comboBox2.Text + "']").Value;

            }
            catch
            {
                richTextBox2.Text = "chua co trong tu dien";
            }
        }
