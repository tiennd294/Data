    ...
    public partial class Form8 : Form
    {
        ...
        public void loaddata2()
        {
            try
            {
                ...
                //pictureBox2.Image = (Image)dataGridView1.Rows[0].Cells[4].Value;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Them2)
            {
                try
                {
                    ...
                    // Lệnh Insert InTo
                    cmd.CommandText = System.String.Concat("Insert Into SanPham(MaSP, TenSP, DonViTinh, DonGia, Hinh) Values(" + "'" + this.textBox1.Text.ToString() + "','" + this.textBox2.Text.ToString() + "','" + this.textBox3.Text.ToString() + "','" + this.textBox4.Text.ToString() + "', @Hinh)");
            ...
            if (!Them2)
            {
                ...
                // Câu lệnh SQL
                cmd.CommandText = System.String.Concat("Update SanPham Set TenSP='" + this.textBox2.Text.ToString() + "',DonViTinh='" + this.textBox3.Text.ToString() + "', DonGia='" + this.textBox4.Text.ToString() + "', Hinh=@Hinh  Where MaSP='" + str + "'");
                // Cập nhật
                cmd.Parameters.Add("@Hinh", SqlDbType.Image).Value = imgdata;
                cmd.CommandType = CommandType.Text;
                cmd.ExecuteNonQuery();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dlg.ShowDialog(this) == DialogResult.OK)
            {
                ...
                label5.Text = filename.Split('\\').Last();
